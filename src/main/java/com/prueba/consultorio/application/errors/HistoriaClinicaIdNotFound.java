...
public class HistoriaClinicaIdNotFound extends ApplicationError {

    private final NonEmptyUUID id;

    public HistoriaClinicaIdNotFound(NonEmptyUUID id) {
        this.id = id;
    }

    @Override
    public String errorCode() {
        return "HISTORIA_CLINICA_NOT_FOUND_ERROR";
    }
    ...
    public String getMessage() {
        return "Historia clinica not found";
    }
