...
public class EspecialidadIdNotFound extends ApplicationError {

    private final NonEmptyUUID id;

    public EspecialidadIdNotFound(NonEmptyUUID id) {
        this.id = id;
    }

    @Override
    public String errorCode() {
        return "ESPECIALIDAD_NOT_FOUND_ERROR";
    }
