...
public class CitaTipoIdNotFound extends ApplicationError {

    private final NonEmptyUUID id;

    public CitaTipoIdNotFound(NonEmptyUUID id) {
        this.id = id;
    }

    @Override
    public String errorCode() {
        return "CITA_TIPO_NOT_FOUND_ERROR";
    }
    ...
    public String getMessage() {
        return "Cita tipo not found";
    }

    @Override
    public Map<String, Object> metadata() {
        return Map.of(
                "citaTipoId", id.getValue()
        );
    }
}
